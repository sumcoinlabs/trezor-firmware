    ...
    if not utils.BITCOIN_ONLY:
        if False:
            ...
            return CoinInfo(
                ...
                decimals=8,
                address_type=63,
                address_type_p2sh=200,
                maxfee_kb=1000000,
                signed_message_header="Sumcoin Signed Message:\n",
                xpub_magic=0x0488b41c, 
                xpub_magic_segwit_p2sh=0x01b26ef6,TODO
                xpub_magic_segwit_native=0x04b24746,TODO
                bech32_prefix="sum",
                cashaddr_prefix=None,
                slip44=2,
                segwit=True,
